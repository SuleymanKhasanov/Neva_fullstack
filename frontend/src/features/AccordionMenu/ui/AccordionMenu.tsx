    ...
    >
      ...
      >
        <div className={styles.menuTitleWrapper}>
          <div className={styles.sectionTitleWrapper}>
            <h2>Neva</h2>
            <Image src={purpleLiquid} alt="" className={styles.purpleLiquid} />
          </div>
          <Button
        ...
        <Accordion type="single" collapsible className={styles.accordion}>
          {nevaCategories.length > 0 ? (
            nevaCategories.map((category) => (
              <AccordionItem key={category.id} value={`neva-${category.id}`}>
      ...
      <div
        className={`${styles.section} ${styles.xSolutionSection} ${
          activeSection === 'X-Solution' ? styles.active : styles.hidden
        }`}
      >
        <div className={styles.menuTitleWrapper}>
          <div className={styles.sectionTitleWrapper}>
            <h2>X-Solution</h2>
            <Image src={blueLiquid} alt="" className={styles.purpleLiquid} />
          </div>
          <Button
            className={styles.toggleButton}
            variant="secondary"
